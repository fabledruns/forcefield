...
func TestOpenCodeRouting(t *testing.T) {
	cases := []struct {
		...
		{"zen", "muse-spark-1.3-contributor-free", "openai-responses"},
		{"zen", "gpt-5.6-sol", "openai-responses"},
		{"zen", "claude-opus-4-8", "anthropic"},
		{"zen", "qwen3.5-plus", "anthropic"},
		...
		{"go", "qwen3.8-flash", "anthropic"},
		{"go", "glm-5.3-flash", "openai-compatible"},
